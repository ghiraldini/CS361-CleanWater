...
if(!($stmt = $mysqli->prepare("INSERT INTO volunteers (first_name, last_name, email, occupation, season, days, region, startDate, endDate) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"))){
	echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
}

if(!($stmt->bind_param("sssssssss",$_POST['fname'],$_POST['lname'],$_POST['email'],$_POST['occupation'],$_POST['season'],$_POST['days'],$_POST['region'],$_POST['startDate'],$_POST['endDate']))){
